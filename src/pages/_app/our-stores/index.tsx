...
import OurStoresBanner from "@/assets/img/banner-our-stores.png";
import OurStoresImg1 from "@/assets/img/loja-1.png";
import OurStoresImg2 from "@/assets/img/loja-2.png";

export const Route = createFileRoute("/_app/our-stores/")({
  component: RouteComponent,
  head: () => ({
    title: "Nossas Lojas - SyntaxWear",
    meta: [{ property: "og:title", content: "Nossas Lojas - SyntaxWear" }],
  }),
});
